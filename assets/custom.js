...
*/
    ...
    $('.navbar-default .navbar-nav>li>a i.fa-search').on('click', function(f) {
	
	if ( $(f.target).is('i.fa-search') ) {
    ...
    $('.top-search form label i.fa-times-circle').on('click', function(c) {
	
	if ( $(c.target).is('i.fa-times-circle') ) {
